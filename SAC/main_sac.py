...
if __name__ == '__main__':
    ...
    for i in range(n_games):
        ...
        print('Game No. ', i, 'score %.1f' % score, 'avg_score %.1f' % avg_score, 'cost %.1f' % penalty, 'avg_cost % .1f' % avg_cost)
    ...
    if not load_checkpoint:
        ...
        plot_learning_curve(x, cost_history, cost_file)

...
def eval_single_agent(eval_dir, eval_episodes):
    ...
    directory_name = "SafetyCarGoalTrainDatasetKeyboard"
    ...
    for episode in range(eval_episodes):
        ...
        while not eval_done:
            ...
            data = {}
            next_eval_obs, reward, cost, terminated, truncated, info = eval_env.step(act)
            # if rollout == 1000:
...
def single_runs_eval(eval_dir, eval_episodes):
    ...
    eval_single_agent(eval_dir, eval_episodes)
    ...
    for env in envs:
        ...
        for algo in algos:
            ...
            for seed in seeds:
                ...
                single_runs_eval(seed_path, eval_episodes)

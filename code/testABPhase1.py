...
# Parameters
SAFETY_THRESHOLD = 0.85  # Define a threshold for determining if the LiDAR value is too close (unsafe)
...
while True:
    ...
    eval_obs = torch.as_tensor(obs, dtype=torch.float32)
    with torch.no_grad():
